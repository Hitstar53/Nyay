          ...
          <TestimonialColumn>
            <TestimonialCard>
              ...
              <TestimonialDesc>
                ...
                <div className='info'>fasdfasdfs asdfadsf adsflaksjdf a;lsdfjas a;sldkfj als klfasjdfasldkf fas;df</div>
                <div className='bar'>
                  <div className='filled'></div>
                </div>
                <div className='raised'><span>$1000 raised of </span> $200000</div>
              </TestimonialDesc>
            </TestimonialCard>
          </TestimonialColumn>
